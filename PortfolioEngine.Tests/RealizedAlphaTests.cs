...
namespace PortfolioEngineLib.Tests
{
    ...
    public class RealisedAlphaTests
    {
        ...
        {
            var res = PortfolioEngine.Analytics.RealisedAlpha(TimeSeriesFactory<double>.SampleData.Gaussian.Create(0, 0.2, 100, 1), TimeSeriesFactory<double>.SampleData.Gaussian.Create(0, 0.2, 100, 1));
            // Check output type
        ...
        public void SimplePerformanceTest()
        {
            ...
            {
                res[c] = PortfolioEngine.Analytics.RealisedAlpha(TimeSeriesFactory<double>.SampleData.Gaussian.Create(mean, stddev, 100, 1), 
        ...
        public void MultivariateTest()
        {
            ...
            var res = PortfolioEngine.Analytics.RealisedAlpha(TimeSeriesFactory<double>.SampleData.Gaussian.Create(mean, stddev, 100, 10),
